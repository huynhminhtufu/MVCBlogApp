...
namespace BlogApp.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,CategoryName,CategoryDescription")] Tbl_Category tbl_Category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,CategoryName,CategoryDescription")] Tbl_Category tbl_Category)
        {
            if (ModelState.IsValid)
            {
